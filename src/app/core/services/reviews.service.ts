...
export class ReviewsService {
  ...
  /**
   * Obtiene las reseñas del proveedor
   */
  getReviews(): Observable<ReviewsApiResponse> {
    const url = 'https://6aa5ded6-1a98-4c3d-a307-5717b77f587c.mock.pstmn.io/api/v1/public/search/reviews?pageSize=10&pageNumber=1';
